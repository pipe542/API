...
namespace WebAPI1.Controllers
{
    ...
    public class UsuarioController : ControllerBase
    {
        ...
        public UsuarioController(ApiCrudContext apiCrudContext, Utilidades utilidades)
        {
        ...
        [HttpPut]
        [Route("Actualizar/{id}")]
        public async Task<IActionResult> Actualizar(int id, [FromBody] UsuarioDTO model)
        {
            var usuario = await _apiCrudContext.Usuarios.FindAsync(id);
            if (usuario == null)
            {
